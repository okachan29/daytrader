...
First game I made in my whole life.
...
## 準備
まずこのゲームはpygameというpythonのライブラリをつかって書かれています。
以下にゲームを始めるまでの手順を書きました。
1. pythonのインストール
    1. pythonをここからダウンロードしてください [Python Homepage](https://www.python.org/downloads/)
    1. ターミナル(もしWindowsならコマンドプロンプト)を開いてください
    1. インストールが成功した場合は下のコードを打つとそのバージョンが表示されます
    ~~~
    python --version
    ~~~
...
あなたはこの企業の筆頭株主であるため、この株価はあなたの取引次第で変動するようになっています。企業が低迷しているときは助けてあげてください。損切りをうまくやり、どうにか流れを変えて企業と自分の利益を上げ続けることがこのゲームの目標です。もし企業が倒産する、または自分が借金を負ってしまったらゲームオーバーです。
